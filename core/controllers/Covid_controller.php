	            ...
	            if ($_POST['action'] == 'registry')
				{
		            ...
		            if (empty($errors))
		            {
		                ...
		                if (!empty($query))
		                {
							...
							$recaptcha = file_get_contents('https://www.google.com/recaptcha/api/siteverify?secret=6LdgUVAaAAAAAKRUlNJfgsAdnXcjIA9eWRd0BIss&response=' . $_POST['recaptcha_request_covid_test']);
