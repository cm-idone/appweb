...
class Laboratory_controller extends Controller
{
	...
	// 			$filter['taker'] = (Session::get_value('vkye_user')['god'] == 'activate_and_wake_up') ? (($_POST['own'] == 'account') ? '' : $_POST['taker']) : '';
	// 			$filter['collector'] = (Session::get_value('vkye_user')['god'] == 'activate_and_wake_up') ? (($_POST['own'] == 'account') ? '' : $_POST['collector']) : '';
	// 			$filter['deleted_status'] = $_POST['deleted_status'];
	// 			$filter['type'] = ($params[0] == 'covid') ? $_POST['type'] : $params[0];
	// 			$filter['start_date'] = ($_POST['deleted_status'] == 'deleted') ? 'all' : $_POST['start_date'];
	// 			$filter['end_date'] = ($_POST['deleted_status'] == 'deleted') ? 'all' : $_POST['end_date'];
	// 			$filter['start_hour'] = ($_POST['deleted_status'] == 'deleted') ? 'all' : $_POST['start_hour'];
	// 			$filter['end_hour'] = ($_POST['deleted_status'] == 'deleted') ? 'all' : $_POST['end_hour'];
	// 			$filter['sended_status'] = (Session::get_value('vkye_user')['god'] == 'activate_and_wake_up') ? (($_POST['own'] == 'account') ? '' : (($_POST['deleted_status'] == 'deleted') ? 'all' : $_POST['sended_status'])) : '';
	//
	...
	// 				'start_hour' => '00:00:00',
	// 				'end_hour' => '23:59:59',
	// 				'sended_status' => (Session::get_value('vkye_user')['god'] == 'activate_and_wake_up') ? 'all' : ''
	// 			]);
	// 		}
	//
	// 		global $global;
	...
	// 											<tr style="width:100%;margin:0px;padding:0px;border:0px;">
	// 												<td style="width:100%;margin:0px;padding:20px 20px 0px 20px;border:0px;box-sizing:border-box;">
	// 													<a style="width:100%;display:block;margin:0px;padding:10px;border:1px dashed #bdbdbd;border-radius:5px;box-sizing:border-box;background-color:#fff;font-size:14px;font-weight:400;text-align:center;text-decoration:none;color:#757575;" href="https://api.whatsapp.com/send?phone=' . $global['custody_chain']['laboratory_phone'] . '">' . Languages::email('whatsapp_us_to_support')[$_POST['lang']] . '</a>
	// 												</td>
	// 											</tr>
	// 											<tr style="width:100%;margin:0px;padding:0px;border:0px;">
	// 												<td style="width:100%;margin:0px;padding:20px 20px 0px 20px;border:0px;box-sizing:border-box;">
	// 													<a style="width:100%;display:block;margin:0px;padding:10px;border:1px dashed #bdbdbd;border-radius:5px;box-sizing:border-box;background-color:#fff;font-size:14px;font-weight:400;text-align:center;text-decoration:none;color:#757575;" href="tel:' . $global['custody_chain']['laboratory_phone'] . '">' . Languages::email('call_us_to_support')[$_POST['lang']] . '</a>
	// 												</td>
	// 											</tr>
	// 											<tr style="width:100%;margin:0px;padding:0px;border:0px;">
