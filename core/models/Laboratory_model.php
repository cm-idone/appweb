	...
	public function update_custody_chain($data, $group = false)
    {
		...
		if (Session::get_value('vkye_user')['god'] == 'activate_and_wake_up')
		{
			    ...
			    <tr style="width:100%;margin:0px;padding:0px;border:0px;">
			        ...
			        <td style="width:80%;margin:0px;padding:0px;border:0px;vertical-align:middle;">
			            <table style="width:100%;margin:0px;padding:0px;border:0px;">
			                <tr style="width:100%;margin:0px;padding:0px;border:0px;">
			                    <td style="width:100%;margin:0px;padding:0px 0px 5px 0px;border:0px;box-sizing:border-box;font-size:24px;font-weight:600;text-transform:uppercase;text-align:right;color:' . $data['custody_chain']['laboratory_colors']['first'] . ';">' . Languages::email('result_report')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . '</td>
			                </tr>
			                <tr style="width:100%;margin:0px;padding:0px;border:0px;">
			                    <td style="width:100%;margin:0px;padding:0px 0px 5px 0px;border:0px;box-sizing:border-box;font-size:18px;font-weight:400;text-transform:uppercase;text-align:right;color:' . $data['custody_chain']['laboratory_colors']['second'] . ';">' .  Languages::email('laboratory_analisys')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . ' <span style="font-weight:600;">' . $data['custody_chain']['laboratory_name'] . '</span></td>
			                </tr>
			                <tr style="width:100%;margin:0px;padding:0px;border:0px;">
			...
			if ($data['custody_chain']['type'] == 'covid_pcr')
				$writing .= Languages::email('pcr_atila_biosystem')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])];
			else if ($data['custody_chain']['type'] == 'covid_an')
				$writing .= Languages::email('an_atila_biosystem')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])];
			else if ($data['custody_chain']['type'] == 'covid_ac')
				$writing .= Languages::email('ac_atila_biosystem')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])];

			$writing .=
			'			</span></td>
					<td style="width:33.33%;margin:0px;padding:0px 0px 5px 0px;border:0px;box-sizing:border-box;font-size:14px;font-weight:400;text-align:left;color:' . $data['custody_chain']['laboratory_colors']['first'] . ';">' . Languages::email('test')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . ' <span style="color:' . $data['custody_chain']['laboratory_colors']['second'] . ';">' . (($data['custody_chain']['type'] == 'covid_pcr' OR $data['custody_chain']['type'] == 'covid_an') ? Languages::email('nasopharynx_secretion')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] : Languages::email('sanguine')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])]) . '</span></td>
				</tr>
				<tr style="width:100%;margin:0px;padding:0px;border:0px;">
			...
			'        </td>
				...
				<tr style="width:100%;margin:0px;padding:0px;border:0px;">
			        <td style="width:100%;margin:0px;padding:0px;border:0px;font-size:14px;font-weight:400;text-align:center;color:' . $data['custody_chain']['laboratory_colors']['first'] . ';">' . Languages::email('immunological_analysis')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . '</td>
				</tr>
			</table>
			...
			if ($data['custody_chain']['type'] == 'covid_pcr' OR $data['custody_chain']['type'] == 'covid_an')
				$writing .= Languages::email('notes_pcr_an_1')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . ' ' . Languages::email('notes_pcr_an_2')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . ' ' . Languages::email('notes_pcr_an_3')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])];
			else if ($data['custody_chain']['type'] == 'covid_ac')
				$writing .= Languages::email('notes_ac_1')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . ' ' . Languages::email('notes_ac_2')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . ' ' . Languages::email('notes_ac_3')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . ' ' . Languages::email('notes_ac_4')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . ' ' . Languages::email('notes_ac_5')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])];
			    ...
			    <tr style="width:100%;margin:0px;padding:0px;border:0px;">
			        ...
			        <td style="width:40%;margin:0px;padding:0px;border:0px;vertical-align:middle;">
			            <table style="width:100%;margin:0px;padding:0px;border:0px;">
			                ...
			                <tr style="width:100%;margin:0px;padding:0px;border:0px;">
			                    <td style="width:100%;margin:0px;padding:0px 0px 5px 0px;border:0px;box-sizing:border-box;font-size:14px;font-weight:400;text-align:center;color:#212121;">' . Languages::email('valid_results_by')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . '</td>
			                </tr>
			                <tr style="width:100%;margin:0px;padding:0px;border:0px;">
			...
			<table style="width:100%;margin:0px;padding:0px 40px 20px 40px;border:0px;box-sizing:border-box;background-color:#fff;">
			    <tr style="width:100%;margin:0px;padding:0px;border:0px;">
			        <td style="width:80%;margin:0px;padding:0px;border:0px;vertical-align:middle;">
			            <table style="width:100%;margin:0px;padding:0px;border:0px;">
			                <tr style="width:100%;margin:0px;padding:0px;border:0px;">
			                    <td style="width:100%;margin:0px;padding:0px 0px 5px 0px;border:0px;box-sizing:border-box;font-size:12px;font-weight:400;text-align:justify;color:#212121;">' . Languages::email('alert_pdf_covid')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . ' ' . Languages::email('accept_terms_1')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . ' ' . $data['custody_chain']['laboratory_name'] . ' ' . Languages::email('accept_terms_2')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . ' ' . Languages::email('our_proccess_available_1')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . ' ' . $data['custody_chain']['laboratory_sanitary_opinion'] . ' ' . Languages::email('our_proccess_available_2')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . ' ' . $data['custody_chain']['laboratory_rfc'] . '</td>
			                </tr>
			                <tr style="width:100%;margin:0px;padding:0px;border:0px;">
			                    <td style="width:100%;margin:0px;padding:0px;border:0px;font-size:18px;font-weight:600;text-transform:uppercase;text-align:left;color:#212121;">' . Languages::email('expedition_date')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . ' ' . $data['end_process'] . '</td>
			                </tr>
			            </table>
			        </td>
			        <td style="width:20%;margin:0px;padding:0px;border:0px;vertical-align:middle;font-size:8px;font-weight:400;text-align:center:color:#212121">
						...
						' . Languages::email('scan_to_security')[(($group == false) ? $data['lang'] : $data['custody_chain']['lang'])] . '
			        </td>
			    </tr>
			</table>
			<table style="width:100%;margin:0px;padding:0px 40px 20px 40px;border:0px;box-sizing:border-box;background-color:#fff;">
		...
		if ($group == false)
		{
			$fields = [
				...
				'lang' => (Session::get_value('vkye_user')['god'] == 'activate_and_wake_up') ? $data['lang'] : null,
