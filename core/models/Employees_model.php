...
class Employees_model extends Model
{
	...
	public function create_employee($data)
	{
		...
		$query = $this->database->insert('employees', [
			...
			'docs' => json_encode([
				'birth_certificate' => !empty($data['files']['docs_birth_certificate']['name']) ? Fileloader::up($data['files']['docs_birth_certificate']) : null,
				'address_proof' => !empty($data['files']['docs_address_proof']['name']) ? Fileloader::up($data['files']['docs_address_proof']) : null,
				'ife' => !empty($data['files']['docs_ife']['name']) ? Fileloader::up($data['files']['docs_ife']) : null,
				'rfc' => !empty($data['files']['docs_rfc']['name']) ? Fileloader::up($data['files']['docs_rfc']) : null,
				'curp' => !empty($data['files']['docs_curp']['name']) ? Fileloader::up($data['files']['docs_curp']) : null,
				'professional_license' => !empty($data['files']['docs_professional_license']['name']) ? Fileloader::up($data['files']['docs_professional_license']) : null,
				'driver_license' => !empty($data['files']['docs_driver_license']['name']) ? Fileloader::up($data['files']['docs_driver_license']) : null,
				'account_state' => !empty($data['files']['docs_account_state']['name']) ? Fileloader::up($data['files']['docs_account_state']) : null,
				'medical_examination' => !empty($data['files']['docs_medical_examination']['name']) ? Fileloader::up($data['files']['docs_medical_examination']) : null,
				'criminal_records' => !empty($data['files']['docs_criminal_records']['name']) ? Fileloader::up($data['files']['docs_criminal_records']) : null,
				'economic_study' => !empty($data['files']['docs_economic_study']['name']) ? Fileloader::up($data['files']['docs_economic_study']) : null,
				'life_insurance' => !empty($data['files']['docs_life_insurance']['name']) ? Fileloader::up($data['files']['docs_life_insurance']) : null,
				'recommendation_letters' => [
					'first' => !empty($data['files']['docs_recommendation_letters_first']['name']) ? Fileloader::up($data['files']['docs_recommendation_letters_first']) : null,
					'second' => !empty($data['files']['docs_recommendation_letters_second']['name']) ? Fileloader::up($data['files']['docs_recommendation_letters_second']) : null,
					'third' => !empty($data['files']['docs_recommendation_letters_third']['name']) ? Fileloader::up($data['files']['docs_recommendation_letters_third']) : null,
				],
				'work_contract' => !empty($data['files']['docs_work_contract']['name']) ? Fileloader::up($data['files']['docs_work_contract']) : null,
				'resignation_letter' => !empty($data['files']['docs_resignation_letter']['name']) ? Fileloader::up($data['files']['docs_resignation_letter']) : null,
				'material_responsive' => !empty($data['files']['docs_material_responsive']['name']) ? Fileloader::up($data['files']['docs_material_responsive']) : null,
				'privacy_notice' => !empty($data['files']['docs_privacy_notice']['name']) ? Fileloader::up($data['files']['docs_privacy_notice']) : null,
				'regulation' => !empty($data['files']['docs_regulation']['name']) ? Fileloader::up($data['files']['docs_regulation']) : null
			]),
			'qr' => $data['qr']['filename'],
